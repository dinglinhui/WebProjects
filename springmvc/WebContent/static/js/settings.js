var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="'+rootPath+'static/css/theme-default.css"><img src="'+rootPath+'static/img/themes/default.jpg"/></a>'            
            +'<a href="#" data-theme="'+rootPath+'static/css/theme-brown.css"><img src="'+rootPath+'static/img/themes/brown.jpg"/></a>'
            +'<a href="#" data-theme="'+rootPath+'static/css/theme-blue.css"><img src="'+rootPath+'static/img/themes/blue.jpg"/></a>'                        
            +'<a href="#" data-theme="'+rootPath+'static/css/theme-white.css"><img src="'+rootPath+'static/img/themes/light.jpg"/></a>'            
            +'<a href="#" data-theme="'+rootPath+'static/css/theme-black.css"><img src="'+rootPath+'static/img/themes/black.jpg"/></a>'
        +'</div>'
