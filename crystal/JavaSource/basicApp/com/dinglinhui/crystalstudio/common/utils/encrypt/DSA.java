...
public class DSA {
	...
	public void run() {
		...
		if ((new java.io.File("key/dsa/myprikey.dat")).exists() == false) {
		...
		try {
			java.io.ObjectInputStream in = new java.io.ObjectInputStream(
					new java.io.FileInputStream("key/dsa/myprikey.dat"));
			...
			java.io.ObjectOutputStream out = new java.io.ObjectOutputStream(
					new java.io.FileOutputStream("key/dsa/myinfo.dat"));
		...
		try {
			java.io.ObjectInputStream in = new java.io.ObjectInputStream(
					new java.io.FileInputStream("key/dsa/mypubkey.dat"));
