package com.dlh.galaxy.web.admin.security;
 ...
 * 
 * 要自定义退出登录的地址，可以通过设置 logout-url 属性：(默认Url为：/j_spring_security_logout) <logout
 * logout-url="/u/logout" logout-success-url="/logout.jsp"
...
public class ValidateCodeUsernamePasswordAuthenticationFilter extends
	...
	/**
	 * 验证成功，跳转的页面 注意：地址必须是 / 或 http 开头的URL地址
	 */
