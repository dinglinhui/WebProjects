...
<link href="<%=basePath%>home/css/reset.css" rel="stylesheet"
	type="text/css" media="screen" />
<link href="<%=basePath%>home/css/styles.css" rel="stylesheet"
	type="text/css" media="screen" />
<link href="<%=basePath%>home/css/print.css" rel="stylesheet"
	type="text/css" media="print" />
<link rel="stylesheet" type="text/css"
	href="<%=basePath%>home/css/brower.css" media="all" />

<script type="text/javascript"
	src="<%=basePath%>home/js/jquery-1.7.1.js"></script>
<script type="text/javascript" src="<%=basePath%>home/js/brower.js"></script>
<script type="text/javascript" src="<%=basePath%>home/js/custom-menu.js"></script>

<link href="<%=basePath%>home/css/onebyone.css" rel="stylesheet"
	type="text/css" media="screen" />
<script src="<%=basePath%>home/js/jquery.cycle.all.min.js"
...
<link rel="stylesheet" href="<%=basePath%>home/css/coda-slider-2.0.css"
	type="text/css" media="screen" />
<script src="<%=basePath%>home/js/jquery.easing.1.3.js"
	type="text/javascript"></script>
<script src="<%=basePath%>home/js/jquery.coda-slider-2.0.js"
	type="text/javascript"></script>
<script type="text/javascript">
	$().ready(function() {
...
<script src="<%=basePath%>home/js/jquery.ui.core.js"
	type="text/javascript"></script>
<script src="<%=basePath%>home/js/jquery.ui.widget.js"
	type="text/javascript"></script>
<script src="<%=basePath%>home/js/jquery.ui.accordion.js"
	type="text/javascript"></script>
<script type="text/javascript">
	jQuery(function() {
...
<link rel="stylesheet" href="<%=basePath%>home/css/prettyPhoto.css"
	type="text/css" media="screen" />
<script src="<%=basePath%>home/js/jquery.prettyPhoto.js"
	type="text/javascript"></script>
...
<script src="<%=basePath%>home/js/image-hover.js" type="text/javascript"></script>
<script src="<%=basePath%>home/js/mailmask.js" type="text/javascript"></script>
		...
		<div id="header">
			<div class="header-content">
				...
				<ul class="topnav alignleft">
					<li class="first active"><a href="#" title="Home"><s:text
								name="view.header.topnav.home"></s:text></a></li>
					<li><a href="#" title="About"><s:text
								name="view.header.topnav.about"></s:text></a>
					...
					<li><a href="#" title="Work"><s:text
								name="view.header.topnav.work"></s:text></a>
					...
					<li><a href="#" title="Blog"><s:text
								name="view.header.topnav.blog"></s:text></a>
						<div class="subnav subnav3">
					...
					<li><a href="#" title="Contact"><s:text
								name="view.header.topnav.contact"></s:text></a>
						<div class="subnav subnav3">
			...
			<div class="content">
					...
					<div id="flashBg">
						<div id="flashLine">
							<div id="flash">
								...
								<a name="#ffffff" id="flash1" target="_blank" href="#"
									style="display:block;background: url('<%=basePath%>home/images/slides/rowboat.jpg') no-repeat scroll 50% 0 transparent;"></a>
								<a name="#ffffff" id="flash2" target="_blank" href="#"
									style="display:block;background: url('<%=basePath%>home/images/slides/feature-08.jpg') no-repeat scroll 50% 0 transparent;"></a>
								<a name="#ffffff" id="flash3" target="_blank" href="#"
									style="display:block;background: url('<%=basePath%>home/images/slides/bg-initiatives-index.jpg') no-repeat scroll 50% 0 transparent;"></a>
								<a name="#ffffff" id="flash4" target="_blank" href="#"
									style="display:block;background: url('<%=basePath%>home/images/slides/google-impact-award.jpg') no-repeat scroll 50% 0 transparent;"></a>
								<a name="#ffffff" id="flash5" target="_blank" href="#"
									style="display:block;background: url('<%=basePath%>home/images/slides/WWF-Case-Story-homepage-large-screen.jpg') no-repeat scroll 50% 0 transparent;"></a>
								<a name="#ffffff" id="flash6" target="_blank" href="#"
									style="display:block;background: url('<%=basePath%>home/images/slides/GPN112363_elephants_(c)_Martin_Harvey_WWF_Canon.jpg') no-repeat scroll 50% 0 transparent;"></a>
				...
				<div class="content_new">
						...
						<div class="coda-slider-wrapper">
							<div class="coda-slider preload" id="coda-slider-1">
								<div class="panel">
									<div class="panel-wrapper">
										<div class="logos alignleft">
											<img src="<%=basePath%>home/images/logos/audiojungle.jpg"
												alt="audiojungle" />
										</div>
										<div class="quote">
											<p>Over the last eighteen months our sales have
												increased by 200%, since the launch of our new website. We
												have to say, it has made us glad to have chosen Tilability!
												Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed
												diam nonumy eirmod tempor invidunt.â</p>
								...
								<div class="panel">
									<div class="panel-wrapper">
										<div class="logos alignleft">
											<img src="<%=basePath%>home/images/logos/themeforest.jpg"
												alt="themeforest" />
										</div>
										<div class="quote">
											<p>Lorem ipsum dolor sit amet, consetetur sadipscing
												...
												dolor sit amet et justo duo dolor. Stet clita kasd
												gubergren, no sea takimata sanctus est Lorem ipsum dolor sit
												amet et justo duo dolor.â</p>
								...
								<div class="panel">
									<div class="panel-wrapper">
										<div class="logos alignleft">
											<img src="<%=basePath%>home/images/logos/photodune.jpg"
												alt="photodune" />
										</div>
										<div class="quote">
					...
					<div class="col1-3">
						...
						<div class="pics">
							<div class="proj-img">
								<a href="<%=basePath%>home/images/shutterstock_84787564.jpg"
									title="Image Title" rel="prettyPhoto"></a><img
									src="<%=basePath%>home/images/image1-s.jpg"
					...
					<div class="col1-3 last">
						...
						<div class="next-to-date">
							...
							<p>
								Pellentesque id neque ut mauris bibendum tempor ut eu nibh
								turpis velit porttitor arcu. <a href="single-post.html"
	...
	<div id="footer">
		<div class="footer-content clearfix">
			...
			<div id="footer-bottom" class="clear">
				<p class="alignleft">Â© 2012 Tilability.com. All rights
					reserved.</p>
				<p class="alignright">
